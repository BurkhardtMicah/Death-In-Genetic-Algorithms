...
for q in range(23):
    ...
    for i in range(gaPopSize):
        ...
        populationArr.append(chromosome(i, np.append(arr, arr[0]))) #Add return to start
    ...
    print(str(round(time.time() - start,2)) + "\t" + str(round(bestDist,2)) + "\t" + str(genFound) + "\t" + str(whenFound))         