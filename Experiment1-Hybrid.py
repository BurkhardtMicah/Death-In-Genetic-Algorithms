...
for q in range(100):
    ...
    while(((generationNumber < numGenertations) and (noChange < numNoChangeGen))):
        ...
        matingPercentage = .966 #Allows only 1 chromosome (the most fit) to continue on to the next generation - rest are replaced on every iteration
        ...
        if(bestDist > populationArr[0].distance):
            ...
            #print("gen number: " + str(generationNumber))
